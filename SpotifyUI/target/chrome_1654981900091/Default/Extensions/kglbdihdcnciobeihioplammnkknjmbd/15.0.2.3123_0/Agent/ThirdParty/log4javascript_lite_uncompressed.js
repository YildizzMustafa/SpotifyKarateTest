 ...
 * Changed By: Wayland Su.
 * Office Address:  Hewlett-Packard Enterprise Software
 *                  No.799 NaXian Road 
                    Pudong Shanghai CHINA
 * 1. Remove HTML content of Popup window, to reduce size.
 * 2. Changes to log4javascript.Appender instead of private Appender, 
 *    to make it possible to customize appender from outside
 
 * Changed By: Easton Liu.
 * Office Address:  Hewlett-Packard Enterprise Software
 *                  No.799 NaXian Road 
                    Pudong Shanghai CHINA
 * 1. Change getLogger to return a new Logger instance.
 *
 */
...
(function() {
	...
	function Logger() {
		var appender = new log4javascript.Appender();
