...
NodeSet.prototype.reserveDelByNodeID = function(id, offset, reverse) {
    ...
    var install = function (win) {
        ...
        win.XPathResult.prototype.iterateNext = function () { return this.nodes[this.index++] || null; };
        win.XPathResult.prototype.snapshotItem = function (i) { return this.nodes[i] || null; };
